    ...
    <fieldset>
          ...
          <section>
              ...
              <?php  
                ...
                $sql = "INSERT INTO pastel (Id_pastel, TipoPastel, NombrePastel, SaborPastel, PrecioPastel, Descripcion, TamanioPastel)
                                  VALUES ('$codigo', '$tipo', '$nombre', '$sabor', '$precio', '$descripcion', '$tam')";
