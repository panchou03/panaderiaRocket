          ...
          <section>
              ...
              <?php  
               ...
               $sabor = $_POST["sabor"];
                ...
                $sql = "INSERT INTO panes (Id_Pan, TipoPan, NombrePan, PIndividual, PDocena, DescripcionPan)
                                  VALUES ('$codigo', '$tipo', '$nombre', '$sabor', '$precio', '$descripcion')";
