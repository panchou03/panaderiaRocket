...
<html lang="es">
  ...
  <div class="cero">
    ...
    <fieldset>
          ...
          <legend>Gelatina Encontrada</legend>
    ...
    $sql="SELECT*FROM gelatina WHERE Id_Gel= $codigo";
    $result = $conn->query($sql);

    if($result->num_rows > 0){
      while($row=$result->fetch_assoc()){
      echo "código: " .$row["Id_Gel"]."<br>"."Nombre: ". $row["NombreGel"]."<br>". "Precio: $".$row["PrecioGel"]."<br>"."Sabor: ".$row["SaborGel"]."<br>" ."Tipo: ".$row["TipoGel"]."<br>" ."Descripcion: ".$row["DescripcionGel"]."<br><br>";
      }
    }else{
      echo"0 resultados";
    }
