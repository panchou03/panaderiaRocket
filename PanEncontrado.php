...
<html lang="es">
  ...
  <div class="cero">
    ...
    <fieldset>
          ...
          <legend>Pan Encontrado Encontrada</legend>
    ...
    $sql="SELECT*FROM panes WHERE Id_Pan= $codigo";
    $result = $conn->query($sql);

    if($result->num_rows > 0){
      while($row=$result->fetch_assoc()){
      echo "código: " .$row["Id_Pan"]."<br>"."Nombre: ". $row["NombrePan"]."<br>". "Precio: $".$row["PrecioIndividual"]."<br>"."Precio por Docena: ".$row["PDocena"]."<br>" ."Tipo: ".$row["TipoPan"]."<br>" ."Descripcion: ".$row["DescripcionPan"]."<br><br>";
      }
    }else{
      echo"0 resultados";
    }
