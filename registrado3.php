    ...
    <fieldset>
          ...
          <section>
              ...
              <?php  
                ...
                $sql = "UPDATE gelatina SET TipoGel='$tipo', NombreGel='$nombre', SaborGel='$sabor', PrecioGel='$precio', DescripcionGel='$descripcion' WHERE Id_Gel=$codigo";

                if ($conn->query($sql) === TRUE) {
                    echo "registro modificado de manera exitosa";
                } else {
